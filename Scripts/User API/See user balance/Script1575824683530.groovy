...
responseData = WS.sendRequest(findTestObject('api/users/user_balance', [('url') : GlobalVariable.url, ('bearer') : bearer]))
...
def balance = resBodyObject.payload.total_balance;

WS.verifyNotEqual(balance, null)
println balance