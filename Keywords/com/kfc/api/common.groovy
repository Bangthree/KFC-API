...
class common {
	...
	//KFC
	def loginByAPI(String phone_number, String merchant_id, String request_id){
		KeywordLogger log = new KeywordLogger();

		def responseData = WS.sendRequest(findTestObject('api/login/user_login', [ ('phone_number') : phone_number, ('merchant_id') : merchant_id, ('request_id') : request_id]));
		...
		def token = resBodyObject.payload.token;
